        ...
        <VerticalTimeline lineColor="#3e497a">
          ...
          >
            ...
            <ul>
              ...
              <li>
                Won a company-wide contest for generating the most engagement
                from an advertisement for a particular product
              </li>
              <li>
                Drafted persuasive emails and proposals in order to sell my
                clients and better articulate their ideas
              </li>
              <li>
                Tailored and refined my writing style to reflect brands and
                industries and better communicate with unique clientele
              </li>
              <li>
                Researched products and services I knew little to nothing about
                and used that information to construct engaging copy
              </li>
              <li>
                Devised clever ways to make both unusual and every-day products
                sound appealing to their target demographic
              </li>
            </ul>
          </VerticalTimelineElement>
          <VerticalTimelineElement
          ...
          >
            ...
            <ul>
              <li>
                Networked and earned the trust of 30+ clients to the extent that
                they felt safe leaving me with their keys and pets
              </li>
              <li>
              ...
              <li>
                Maintained an ever-changing schedule for myself and walkers and
                kept careful track of payments and invoices
              </li>
            </ul>
          </VerticalTimelineElement>
