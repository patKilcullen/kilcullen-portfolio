...
},
{
    ...
    about: "My first substantial group project. I spent ample time working out the authentication features of the app, as well as the cart feature, which was the first time I worked extensively with a through table.",
...
},
{
    ...
    about: "It may not look like much, but I was proud of my first full stack CRUD app. I received the highest grade in my cohort of 60+ students, and my instructor described it as the 'Best project I have seen yet!' I put a lot of effort into it and thoroughly searched for and eliminated many bugs.",
